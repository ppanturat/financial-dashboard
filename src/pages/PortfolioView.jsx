...
export function PortfolioView({ 
  ...
  const [activeChart, setActiveChart] = useState('growth') // Toggle state for charts
  ...
  const pieData = holdings.map(h => {
    ...
    // 2. BULLETPROOF MARKET PRICE LOOKUP (Handles case sensitivity)
